...
DROP TABLE IF EXISTS "test-data"."default"."eckins_interval_86400_checkins"

CREATE TABLE "test-data"."default"."eckins_interval_86400_checkins" AS
SELECT
  *
FROM
  (
...
-- 30 rows
INSERT INTO "test-data"."default"."eckins_interval_86400_checkins" ("id", "timestamp")
VALUES
