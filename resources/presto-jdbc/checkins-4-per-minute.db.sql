...
DROP TABLE IF EXISTS "test_data"."default"."checkins_interval_15_checkins";

CREATE TABLE "test_data"."default"."checkins_interval_15_checkins" ("id" INTEGER, "timestamp" TIMESTAMP WITH TIME ZONE);

-- 30 rows
INSERT INTO "test_data"."default"."checkins_interval_15_checkins" ("id", "timestamp")
VALUES
