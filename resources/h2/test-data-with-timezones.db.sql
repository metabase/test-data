...
GRANT ALL ON "CATEGORIES" TO GUEST;
...
ALTER TABLE
  "VENUES"
ADD
  CONSTRAINT "TEGORY_ID_CATEGORIES_341257635" FOREIGN KEY ("CATEGORY_ID") REFERENCES "CATEGORIES" ("ID");

ALTER TABLE
  "CHECKINS"
ADD
  CONSTRAINT "ECKINS_USER_ID_USERS_660849906" FOREIGN KEY ("USER_ID") REFERENCES "USERS" ("ID");

ALTER TABLE
  "CHECKINS"
ADD
  CONSTRAINT "INS_VENUE_ID_VENUES_1367144309" FOREIGN KEY ("VENUE_ID") REFERENCES "VENUES" ("ID");
