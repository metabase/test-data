...
DROP TABLE IF EXISTS ` checkins_interval_900 `.` checkins `

CREATE EXTERNAL TABLE ` checkins_interval_900 `.` checkins ` (` id ` INT, ` timestamp ` TIMESTAMP) LOCATION 's3://metabase-ci-athena-results/checkins_interval_900/checkins/';

-- 30 rows
INSERT INTO "checkins_interval_900"."checkins" ("id", "timestamp")
VALUES
